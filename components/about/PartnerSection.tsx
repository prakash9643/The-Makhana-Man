    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden" aria-hidden="true">
        <span
          ...
          style={{ fontSize: "clamp(60px,14vw,190px)", opacity: 0.04, color: "#fff", letterSpacing: "0.04em" }}
        >
          PARTNER
        </span>
      </div>
      ...
      <div className="relative max-w-screen-2xl mx-auto px-4 md:px-10">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          {/* sub-label — same as PillarsSection badge */}
          <motion.div
          ...
          {/* subheading paragraph — matched to PillarsSection card <p> */}
          <motion.p
            className="font-bold uppercase font-family-cosmic-sans max-w-xl mt-4"
            style={{ fontSize: "13px", lineHeight: "1.6", letterSpacing: "0.05em", color: "rgba(255,255,255,0.65)" }}
            initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
          {partnerTypes.map((p, i) => (
            ...
            >
              ...
              {/* card heading — matched to PillarsSection card h3 */}
              <h3
                className="font-bold uppercase font-family-more-sugar"
                style={{
              ...
              {/* card paragraph — matched to PillarsSection card <p> */}
              <p
                className="font-bold uppercase font-family-cosmic-sans"
                style={{ fontSize: "13px", lineHeight: "1.6", letterSpacing: "0.05em", color: "rgba(255,255,255,0.60)" }}
              >
                {p.desc}
              </p>
            </motion.div>
        ...
        >
          {/* CTA tagline — matched to PillarsSection h2 style, slightly smaller */}
          <p
            className="font-bold uppercase font-family-more-sugar text-center"
            style={{ fontSize: "clamp(1.1rem, 1.8vw, 1.45rem)", lineHeight: "1.15", letterSpacing: "3px", color: "rgba(255,255,255,0.80)" }}
          >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <Link
              href="/contact"
              className="font-family-cosmic-sans inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold uppercase border-2 border-white/30 text-white transition-all duration-300 hover:bg-white/10"
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <p
              className="font-bold uppercase font-family-more-sugar"
              style={{ fontSize: "clamp(9px, 1.3vw, 11px)", lineHeight: "1.15", letterSpacing: "3px", color: "rgba(255,255,255,0.45)" }}
            >
