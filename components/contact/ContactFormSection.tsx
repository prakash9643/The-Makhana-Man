  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        onChange={onChange}
        required={required}
        className="w-full font-bold uppercase font-family-cosmic-sans rounded-xl px-4 py-3 outline-none transition-all duration-200"
        style={{
          fontSize: "13px",
          lineHeight: "1.6",
...
export function ContactFormSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const url = `https://wa.me/917739756165?text=${encodeURIComponent(msg)}`
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg, #f9f3ea 0%, #fdf5e8 60%, #e8f2ec 100%)" }}
    >
      {/* Ghost watermark */}
      <div
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            >
              ...
              <span
                className="font-bold uppercase font-family-cosmic-sans text-[#c14b33]"
                style={{ fontSize: "10px", letterSpacing: "0.1em" }}
              >
                Send a Message
              </span>
            ...
            {submitted ? (
              ...
              >
                ...
                <button
                  ...
                  className="mt-6 font-bold uppercase font-family-cosmic-sans px-6 py-2.5 rounded-full"
                  style={{ fontSize: "13px", lineHeight: "1.6", letterSpacing: "0.05em", backgroundColor: "#046b46", color: "#fff" }}
                >
                  Send Another
                </button>
              </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <InputField label="Your Name" name="name" placeholder="Ramesh Kumar" value={form.name} onChange={handleChange} required />
                  <InputField label="Phone Number" name="phone" type="tel" placeholder="+91 98765 43210" value={form.phone} onChange={handleChange} required />
                </div>

                {/* Row 2 */}
                <InputField label="Email Address" name="email" type="email" placeholder="your@email.com" value={form.email} onChange={handleChange} />
                  ...
                  <div className="flex flex-wrap gap-2">
                    {enquiryTypes.map((t) => (
                      <button
                        ...
                        className="font-bold uppercase font-family-cosmic-sans px-3 py-1.5 rounded-full transition-all duration-200"
                        style={{
                          fontSize: "13px",
                          lineHeight: "1.6",
                          letterSpacing: "0.05em",
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full font-bold uppercase font-family-cosmic-sans rounded-xl px-4 py-3 outline-none transition-all duration-200 resize-none"
                    style={{
                      fontSize: "13px",
                      lineHeight: "1.6",
                      letterSpacing: "0.05em",
